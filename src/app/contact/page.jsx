        ...
        <div className="max-w-lg mx-auto gap-12 flex flex-col lg:flex-row lg:max-w-none">
          <div className="max-w-lg sm:text-center lg:text-left">
            ...
            <p className="mt-3">
              ...
              disponibilidad y preferencia para que podamos avanzar con agilidad
          ...
          <div className="flex-1 w-full mt-12 lg:mt-0">
            ...
            <ContactForm servicesItems={servicesItems} isSubmitting={isSubmitting} handleSubmit={handleSubmit}/>
...
function ContactForm({ servicesItems, isSubmitting, handleSubmit }) {
  return(
