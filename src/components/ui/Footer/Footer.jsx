const socialInfo = [
  ...
  {
      icon: <div className="w-6 h-6 hover:bg-sky-600 duration-150 p-1 bg-white flex items-center justify-center rounded-full">
